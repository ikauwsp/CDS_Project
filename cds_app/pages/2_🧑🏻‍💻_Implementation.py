...
class project_pipeline():
    st.image(os.path.join('assets', 'CDS_pipeline.png'))
...
class dataset():
    ...
    st.image(os.path.join('assets', 'dataset1.png'), caption='The video lengths distribution shows that most of the videos in our dataset fall below 10-20 seconds')
    st.image(os.path.join('assets', 'dataset2.png'), caption='The uneven distribution shown prompts us to do data manipulation during our dataloading.')
...
class feature_processing():
    ...
    st.image(os.path.join('assets', 'text_extraction_pipeline.png'), caption='Using Mozilla DeepSpeech, BERT and Autoencoder.')
    st.subheader('Text Preprocessing Visualization')
    st.image(os.path.join('assets', 'text1.png'))
    st.image(os.path.join('assets', 'text2.png'))
    ...
    st.image(os.path.join('assets', 'audio1.png'))
    st.image(os.path.join('assets', 'audio2.png'), caption="The correlation heatmap shows that the features are more or less independent with respect to each other, except some.")

    st.subheader('Facial Processing')
    st.image(os.path.join('assets', 'facial_extraction_pipeline.png'), caption='Using OpenCV Haar Cascade and ResNet50')
    st.subheader('Facial Preprocessing Visualization')
    st.image(os.path.join('assets', 'facial1.png'))
    st.image(os.path.join('assets', 'facial2.png'))
